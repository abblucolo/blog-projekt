<template>
  <nav class="w-full p-6 bg-white sticky top-0 left-0 right-0 border-b-2 z-50">
    <div class="flex items-center justify-between container">
      ...
      <div>
        <img class="w-auto md:block h-10" src="../static/Ephoto360.com_16262c6635dd38.jpg">
      </div>
      ...
      <div class="hidden md:block">
        <ul class="flex space-x-8 text-lg font-sans text-light-grey">
          <li><a href="/" class="NavBarLink">Blog</a></li>
      ...
      <aside class="p-5 transform top-0 left-0 w-64 bg-white fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30" :class="isOpen ? 'translate-x-0' : '-translate-x-full'">
        ...
        <ul class="divide-y font-sans">
          <li><a href="/" @click="isOpen = false" class="my-8 w-full text-center font-semibold cta inline-block bg-blue-500 hover:bg-blue-600 px-3 py-2 rounded text-white">Home</a></li>
          <li><a href="/about" @click="isOpen = false" class="my-4 inline-block">About</a></li>
          <li><a href="/contact" @click="isOpen = false" class="my-4 inline-block">Contact</a></li>
          <li><a class="my-4 inline-block"></a></li>
        </ul>
